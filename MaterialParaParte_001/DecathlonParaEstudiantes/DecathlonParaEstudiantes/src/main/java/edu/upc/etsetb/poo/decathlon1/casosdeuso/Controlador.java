...
public class Controlador {
    ...
    public Controlador(String nombre, String fecha,
        ...
        throw new UnsupportedOperationException("Controlador::Controlador(....). No implementado todavía.");
    }
    ...
    public void inicializaConAtletasYMarcasIniciales() {
        ...
        inscribirAtleta("Dmitriy Karpov", "KAZ");   // 900 pts por prueba
    ...
    public void inscribirAtleta(String nombre, String nacionalidad) {
        throw new UnsupportedOperationException("Controlador::inscribirAtleta(St"
                + "ring nombre, String nacionalidad). No implementado todavía.");
    }
    ...
    public String getInfoCompeticion() {
        throw new UnsupportedOperationException("Controlador::getInfoCompeticion"
    ...
    public int getNumInscritosEnCompeticion() {
        throw new UnsupportedOperationException("Controlador::getNumInscritosEnC"
                + "ompeticion(). No implementado todavía.");
    }
    ...
    public String getInfoAtleta(int numInscripcion) {
        throw new UnsupportedOperationException("Controlador::getInfoAtleta(int "
                + "numInscripcion). No implementado todavía.");
    }
    ...
    public int anyadirMarcaEnEventoDeUnAtleta(int numInscripcion, int evento, double marca) {
        throw new UnsupportedOperationException("Controlador::anyadirMarcaEnEven"
                + "toDeUnAtleta(int numInscripcion, int evento, double marca). No implementado todavía.");
    }
    ...
    public String getClasificacion(int numAtletas) {
        throw new UnsupportedOperationException("Controlador::getClasificacion("
